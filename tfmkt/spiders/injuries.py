...
class InjuriesSpider(BaseSpider):
    ...
    def parse(self, response, parent):
        ...
        return response.follow(injuries_link, self.extract_injuries_info, cb_kwargs=cb_kwargs)
    ...
    def extract_injuries_info(self, response, base):
        ...
        for navigation in injury_navigations:
            ...
            if injury_href not in injury_links:
                ...
                yield response.follow(injury_href, self.parse_injury_table, cb_kwargs=cb_kwargs)     
